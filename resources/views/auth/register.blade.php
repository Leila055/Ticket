            ...
            <p class="text-center text-muted mb-3">create an account if you don't have one.</p>
             ...
             @csrf
              ...
              <div class="col-md-12">
                ...
                <input type="text" class="form-control"  id="email" name="email" value="{{old('email')}}" required autocomplete="email" url-emailExist="{{route('app_exist_email')}}" token="{{csrf_token()}}" > 
              ...
              <div class="d-grid gap-2">
                  <button class="btn btn-primary" type="button" id="register-user" title="Register">Register</button>
              </div>
